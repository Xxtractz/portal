<?php
  ...
  define('PROOT', '/portal/'); // set this to '/' for a live server.
  ...
  define('SITE_TITLE', 'Eagle Payout System'); // This will be used if no site title is set
  define('MENU_BRAND', 'Eagle Payout System'); //This is the Brand text in the menu
