...
class Users extends Model {
  ...
  public $id,$fname,$lname,$idNo,$email,
      $mobile,$entity,$reference,$accNo,
      $Accholder,$bankName,$accType,$branchcode,
      $username,$password,$acl,$verify,
      $confirm_code,$notify,$deleted = 0,$confirm;
